...
# ---------- Routes ----------
@router.get("/summary")
async def get_order_summary(start: str = Query(...), end: str = Query(...)):
...
async def export_summary_pdf(start: str = Query(...), end: str = Query(...)):
    start_date = parse_date(start)
    end_date = parse_date(end)
...
async def export_summary_csv(start: str = Query(...), end: str = Query(...)):
    start_date = parse_date(start)
    end_date = parse_date(end)
